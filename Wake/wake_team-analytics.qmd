...
- **Passing accuracy (Passes %)** is the strongest positive predictor of victory (r = 0.326), indicating ball control mastery
- **Back passes completed** and **Touches in penalty area** show strong correlations with winning (r = 0.322 and 0.281)
- **Defensive duels total** is the strongest negative predictor (r = -0.319), suggesting fewer defensive actions correlate with success
- **Penalty area entries that are runs** negatively correlates with winning (r = -0.251), indicating structured attacks may be more effective
...
*Interpretation*: High positive correlations indicate metrics where Wake excels lead to winning (e.g. passing accuracy, back passes completed), while negative correlations highlight areas where increases harm performance (e.g. defensive duels total, penalty area entries that are runs). The results emphasize possession-based success and efficient, structured attacking play.
...
**Evolution Insights:**
- **2024 Decline**: Significant negative trends in most metrics from 2023 to 2024, indicating performance regression
- **Set Piece Strength**: Corners completed shows strong positive growth (+67.4% in 2022, +8.8% in 2023)
- **Attacking Concerns**: Major declines in xG (-14.6%), crosses completed (-37%), and offensive duels (-14.9%) in 2024
- **Possession Challenges**: PPDA improved dramatically in 2023 (+34.1%) but declined in 2024 (-14.8%), suggesting defensive organization issues
...
- **xG**: Major decline (-14.6%) indicating reduced chance creation quality
- **Crosses completed**: Severe drop (-37%) suggesting wing play deterioration  
- **Offensive duels won**: Significant decline (-14.9%) showing reduced attacking aggression
- **PPDA**: Defensive organization regression (-14.8%) after strong 2023 improvement

#### **🟡 Concerning Trends (2022-2024)**
- **Aerial duels won**: Consistent decline (-7.9%, -11.3%, -9.3%) showing physical weakness development
- **Passes/Possession**: Erratic pattern with major 2024 decline (-15.5%) indicating possession inefficiency
- **Tempo**: Declining match pace (-15.4% in 2024) suggesting reduced intensity

#### **🟢 Sustained Improvements (2022-2024)**
- **Corners completed**: Strong and consistent growth (+67.4%, +8.8%) showing set piece mastery
- **Outside Box Shots**: Excellent improvement trend (+6.1%, +15.7%, +7.9%) expanding attacking range
- **Defensive duels won**: Positive development (+6%, +12.3%) despite 2023 dip, showing defensive resilience
- **Pass length**: Steady improvement (+4.7%) indicating more progressive passing approach

### **Strategic Implications**

#### **Immediate Action Required**
1. **Chance Creation Recovery**: Address xG decline through improved final third movement and shot selection
2. **Wing Play Rehabilitation**: Rebuild crossing ability and wide attacking effectiveness
3. **Physical Conditioning**: Reverse aerial duel decline through targeted strength and positioning training

#### **Build on Strengths**
1. **Set Piece Excellence**: Leverage corner success for more varied dead ball situations
2. **Long Range Shooting**: Capitalize on outside box shot improvement for expanded attacking threat
3. **Defensive Foundation**: Build on defensive duel improvements for stronger overall defending
...
**Executive Summary:** The individual metric analysis reveals **eight critical performance factors** that directly influence Wake Forest's match outcomes, with **Shots On Target** emerging as the strongest predictor of success at r = 0.51.
...
::: {.callout-important}
**Targets:**
- **Win Rate**: 70%+ in the upcoming season (building from current 68.9%)
- **xG Recovery**: Return to 2023 levels (+14.6% improvement needed)
- **Shots On Target**: Maintain >50% correlation strength through precision training
- **Corner Effectiveness**: Achieve 75%+ success rate (building on current strength)
- **Crossing Accuracy**: Recover from 37% decline to positive trend
- **Aerial Duel Success**: Reverse 3-year decline trend (+15% improvement target)
:::